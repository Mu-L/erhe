...
void Texture_graph_window::resolve_target()
{
    ...
    // whose hosting scene is no longer registered; a host-less asset
    // (library orphan) stays editable, as before.
...
void Texture_graph_window::set_node_position(Graph_editor_node& node, const ImVec2& position)
{
...
void Texture_graph_window::build_palette()
{
    ...
    const char* const category_order[] = { "Generators", "Gradients", "Patterns", "Filters", "Color", "Transform", "Channels", "Utility" };
