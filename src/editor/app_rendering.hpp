...
public:
    ...
    erhe::graphics::Base_render_pipeline bone4_depth;
    erhe::graphics::Base_render_pipeline bone5_visible_color;
    erhe::graphics::Color_blend_state    bone6_hidden_color_blend;
